...
class BasePage(object):
    ...
    def get_wait_check_page_result(self, locator, timeout=5):
        """页面检查点判断方法"""
        try:
            WebDriverWait(self.driver, timeout, 0.5).until(EC.visibility_of_any_elements_located(locator))
            return True
        except:
            return False
    ...
    @staticmethod
    def reform_json(js):
        return json.dumps(js, sort_keys=True, indent=4, separators=(',', ':'), ensure_ascii=False)
