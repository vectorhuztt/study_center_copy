    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            if flag in str(e):
                ...
                raise WebDriverException(flag + _screenshot('Error'))
            ...
            if flag in str(e):
                ...
                raise AssertionError(flag + _screenshot('Error'))
            ...
            if flag in str(e):
                ...
                raise Exception(flag + _screenshot('Error'))
...
def _wrapper(func):
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            log.e('WebDriverException, %s', e)
            log.e('<-- %s, %s, %s\n', func.__qualname__, 'WebDriverException',
                  'Error')
            ...
            log.e('AssertionError, %s', e)
            log.e('<-- %s, %s, %s\n', func.__qualname__, 'AssertionError',
                  'Fail')
